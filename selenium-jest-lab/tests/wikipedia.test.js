...
describe('Wikipedia Selenium Tests', () => {
    ...
    test('перевірка елементів статті Selenium', async () => {
    ...
    test('пернехід на зовнішнє посилання та перевірка', async () => {
        await driver.get('https://en.wikipedia.org/wiki/Selenium');
    ...
    test('перевірка динамічних елементів та CSS властивостей', async () => {
        await driver.get('https://en.wikipedia.org/wiki/Selenium');
